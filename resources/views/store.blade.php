...
@section('content')
    <div class="row front">
        <div class="col-4">
            ...
            @else
                <img src="https://via.placeholder.com/256X197.png?text=logo" alt="Logo da Loja {{$store->name}}" class="img-fluid">
            @endif
        </div>
        <div class="col-8">
            <h2>{{$store->name}}</h2>
        ...
        @empty
            <div class="col-12">
                <h3 class="alert alert-warning">Nenhuma encontrado para essa loja</h3>
            </div>
        @endforelse
    </div>
